...
WebUI.setText(findTestObject('Object Repository/Page_Register - Passpod/input_Destinasi Utama_form-control_1_2'), '12345678091@gmail.com')
...
WebUI.verifyEqual(url, 'https://passpod.com/')
